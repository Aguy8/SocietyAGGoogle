...
export default function Fonctionnalites() {
  ...
  return (
    <div className="page">
        ...
        <div className="container">
          <div style={{ maxWidth: 900 }}>
            ...
            <h1 style={{ fontSize: 100, marginTop: 28, lineHeight: 0.9 }}>
              5 modules.<br />
              <span style={{ color: 'var(--cobalt)' }}>1 plateforme</span>.<br />
              Zéro friction.
            </h1>
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 56, flexWrap: 'wrap' }}>
            {MODULES.map((m, i) => (
              <button key={i} onClick={() => scrollTo(i)}
                style={{ padding: '12px 20px', background: 'white', color: 'var(--encre)', borderRadius: 999, fontSize: 14, fontWeight: 600, border: '1px solid #E5E5E5', cursor: 'pointer', fontFamily: 'inherit' }}>
                <span style={{ color: 'var(--cobalt)', marginRight: 8 }}>{`0${i + 1}`}</span>{m}
              </button>
            ))}
          </div>
        </div>
          ...
          <div className="two-col-grid">
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 24 }}>
                <div style={{ padding: '6px 14px', background: 'var(--cobalt)', color: 'white', borderRadius: 999, fontSize: 13, fontWeight: 700 }}>MODULE 01</div>
            ...
            <div style={{ background: '#F2F2F2', borderRadius: 32, padding: 32, position: 'relative', minHeight: 600, overflow: 'hidden' }}>
              <div style={{ background: 'white', borderRadius: 20, padding: 28, boxShadow: '0 20px 60px rgba(0,0,0,0.08)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
                  ...
                  <div style={{ padding: '6px 12px', background: '#E8EFFC', color: 'var(--cobalt)', borderRadius: 999, fontSize: 12, fontWeight: 600 }}>● Démo</div>
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 10, marginBottom: 20 }}>
                  {[['Membres', '1 248', '+18'], ['Cotisations', '94 %', '+5 %'], ['Projets', '12', '4 actifs']].map((s, i) => (
                    <div key={i} style={{ padding: 14, background: '#F8F8F8', borderRadius: 12 }}>
                      ...
                      <div style={{ fontSize: 11, color: 'var(--cobalt)', marginTop: 2 }}>{s[2]}</div>
                    </div>
                  ))}
                </div>
                <div style={{ padding: 16, background: '#F8F8F8', borderRadius: 12, marginBottom: 12 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-end', gap: 3, height: 60 }}>
                    {[40, 55, 35, 70, 60, 82, 75, 90, 65, 80, 95, 88, 72, 85].map((h, i) => (
                      <div key={i} style={{ flex: 1, height: `${h}%`, background: i === 11 ? 'var(--cobalt)' : '#D5DCEA', borderRadius: 3 }} />
                    ))}
                  </div>
                </div>
                <div style={{ display: 'grid', gap: 8 }}>
                  {[
                    ...
                    <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: 10, background: '#F8F8F8', borderRadius: 10 }}>
                      ...
                      <div style={{ padding: '4px 10px', background: '#E8EFFC', color: 'var(--cobalt)', borderRadius: 999, fontSize: 11, fontWeight: 600 }}>À jour</div>
                    </div>
                  ))}
                </div>
              </div>
      ...
      {/* MODULE 2 */}
      <section ref={refs[1]} data-nav-theme="dark" style={{ padding: '120px 64px', background: 'var(--encre)', color: 'white', scrollMarginTop: 80 }}>
        <div className="container">
          <div className="two-col-grid">
            <div style={{ order: 2 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 24 }}>
                <div style={{ padding: '6px 14px', background: 'var(--cobalt)', color: 'white', borderRadius: 999, fontSize: 13, fontWeight: 700 }}>MODULE 02</div>
            ...
            <div style={{ order: 1, position: 'relative', minHeight: 560 }}>
              <div style={{ position: 'absolute', inset: 0, background: 'var(--cobalt)', borderRadius: 40, transform: 'rotate(2deg)' }} />
              <div style={{ position: 'absolute', top: 32, left: 32, right: 32, bottom: 32, background: 'white', borderRadius: 28, padding: 28, color: 'var(--encre)' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'baseline', gap: 6, marginTop: 20 }}>
                  <span style={{ fontSize: 48, fontWeight: 800, letterSpacing: '-0.04em', color: 'var(--cobalt)' }}>7 245</span>
                  <span style={{ fontSize: 24, fontWeight: 800, color: 'var(--cobalt)' }}>K</span>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13, color: '#6B6B6B', marginTop: 4 }}>
                  ...
                  <span style={{ fontWeight: 700, color: 'var(--cobalt)' }}>72 %</span>
                </div>
                <div style={{ height: 8, background: '#F2F2F2', borderRadius: 999, marginTop: 8, overflow: 'hidden' }}>
                  <div style={{ width: '72%', height: '100%', background: 'linear-gradient(90deg, var(--cobalt), var(--cobalt-deep))' }} />
                </div>
                <div style={{ marginTop: 20, display: 'grid', gap: 8 }}>
                  {[
                    ...
                    <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 0', borderTop: '1px solid #F2F2F2' }}>
                      ...
                      <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--cobalt)' }}>{d.m}</div>
                    </div>
                  ))}
                </div>
                <NavLink to="/inscription" style={{ marginTop: 16, display: 'block', width: '100%', padding: 14, background: 'var(--cobalt)', color: 'white', border: 'none', borderRadius: 12, fontSize: 14, fontWeight: 700, cursor: 'pointer', textAlign: 'center', textDecoration: 'none', boxSizing: 'border-box' }}>Faire un don</NavLink>
              </div>
            </div>
          </div>
        </div>
      ...
      <section ref={refs[2]} style={{ padding: '120px 64px', scrollMarginTop: 80 }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 24 }}>
                <div style={{ padding: '6px 14px', background: 'var(--cobalt)', color: 'white', borderRadius: 999, fontSize: 13, fontWeight: 700 }}>MODULE 03</div>
                <div style={{ height: 1, flex: 1, background: '#E5E5E5' }} />
              </div>
            ...
            <div style={{ background: '#F8F8F8', borderRadius: 32, padding: 40 }}>
              ...
              <div style={{ background: 'white', borderRadius: 20, padding: 24, boxShadow: '0 10px 40px rgba(0,0,0,0.06)', marginBottom: 16 }}>
                <div style={{ fontSize: 11, color: 'var(--cobalt)', fontWeight: 700, textTransform: 'uppercase' }}>Besoin</div>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', margin: '16px 0' }}>
                <div style={{ padding: '10px 24px', background: 'var(--cobalt)', color: 'white', borderRadius: 999, fontSize: 14, fontWeight: 700 }}>
                  ⚡ 96 % de compatibilité
                </div>
              </div>
              <div style={{ background: 'white', borderRadius: 20, padding: 24, boxShadow: '0 10px 40px rgba(0,0,0,0.06)' }}>
                <div style={{ fontSize: 11, color: 'var(--cobalt)', fontWeight: 700, textTransform: 'uppercase' }}>Profil trouvé</div>
      ...
      {/* MODULE 4 */}
      <section ref={refs[3]} data-nav-theme="dark" style={{ padding: '120px 64px', background: 'var(--cobalt)', color: 'white', scrollMarginTop: 80 }}>
        <div className="container">
          <div className="two-col-grid">
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 24 }}>
            ...
            <div style={{ padding: 40, background: 'rgba(255,255,255,0.08)', borderRadius: 32, backdropFilter: 'blur(10px)', border: '1px solid rgba(255,255,255,0.15)' }}>
              ...
              <button style={{ marginTop: 20, width: '100%', padding: 14, background: '#E8EFFC', color: 'var(--cobalt)', border: 'none', borderRadius: 12, fontSize: 14, fontWeight: 700, cursor: 'pointer' }}>
      ...
      <section ref={refs[4]} style={{ padding: '120px 64px', scrollMarginTop: 80 }}>
        <div className="container">
          <div className="two-col-grid">
            <div style={{ order: 2 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 24 }}>
                <div style={{ padding: '6px 14px', background: '#E8EFFC', color: 'var(--cobalt)', borderRadius: 999, fontSize: 13, fontWeight: 700 }}>MODULE 05</div>
                <div style={{ height: 1, flex: 1, background: '#E5E5E5' }} />
              </div>
              ...
              <div style={{ marginTop: 40, display: 'grid', gap: 4 }}>
                {[
                  ...
                  <div key={i} style={{ padding: '20px 0', borderBottom: '1px solid #E5E5E5', display: 'grid', gridTemplateColumns: '40px 1fr', gap: 16 }}>
                    <div style={{ width: 36, height: 36, borderRadius: 10, background: '#E8EFFC', display: 'grid', placeItems: 'center' }}>
                      <Icon name="award" size={18} color='var(--cobalt)' />
                    </div>
                    <div>
                      <div style={{ fontWeight: 700, fontSize: 16 }}>{titre}</div>
                      <div style={{ color: '#6B6B6B', fontSize: 14, marginTop: 4 }}>{desc}</div>
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                <div style={{ background: 'white', borderRadius: 20, padding: 24, marginBottom: 16, boxShadow: '0 10px 40px rgba(0,0,0,0.08)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <div style={{ padding: '6px 12px', background: 'var(--encre)', color: 'white', borderRadius: 999, fontSize: 12, fontWeight: 700 }}>VIP</div>
                  </div>
                ...
                <div style={{ background: 'white', borderRadius: 20, padding: 24, marginBottom: 16, boxShadow: '0 10px 40px rgba(0,0,0,0.08)' }}>
                  ...
                  <div style={{ fontSize: 13, color: 'var(--cobalt)', fontWeight: 600, marginTop: 4 }}>↑ 32 % vs mois dernier</div>
                  <div style={{ marginTop: 12, display: 'flex', alignItems: 'flex-end', gap: 3, height: 40 }}>
                    {[30, 45, 38, 60, 55, 72, 65, 80, 75, 90].map((h, i) => (
                      <div key={i} style={{ flex: 1, height: `${h}%`, background: i === 9 ? 'var(--cobalt)' : '#DDE0FF', borderRadius: 3 }} />
                    ))}
                  </div>
                </div>
                <div style={{ background: 'white', borderRadius: 20, padding: 20, boxShadow: '0 10px 40px rgba(0,0,0,0.08)' }}>
                  ...
                  {[
                    ...
                    <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 0', borderTop: i ? '1px solid #F2F2F2' : 'none' }}>
                      ...
                      <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--cobalt)' }}>{c.prix}</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <thead>
                <tr style={{ background: '#F2F2F2' }}>
                  ...
                  {['WhatsApp', 'Facebook', 'Circle.so', 'Society'].map((h, i) => (
                    <th key={h} style={{ padding: 20, textAlign: 'center', fontSize: 13, fontWeight: 700, color: i === 3 ? 'white' : '#6B6B6B', background: i === 3 ? 'var(--cobalt)' : 'transparent' }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                  ...
                  <tr key={i} style={{ borderTop: '1px solid #E5E5E5' }}>
                    ...
                    {[1, 2, 3, 4].map(c => (
                      <td key={c} style={{ padding: 18, textAlign: 'center', background: c === 4 ? '#F4F7FE' : 'transparent' }}>
                        {row[c] === 2 && <span style={{ display: 'inline-grid', placeItems: 'center', width: 26, height: 26, borderRadius: '50%', background: 'var(--cobalt)', color: 'white', fontSize: 13 }}>✓</span>}
      ...
      <section style={{ padding: '120px 64px' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          <h2 style={{ fontSize: 72, maxWidth: 800, margin: '0 auto' }}>Tout ça,<br />en <span style={{ color: 'var(--cobalt)' }}>5 minutes</span>.</h2>

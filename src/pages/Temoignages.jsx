...
const TEMOIGNAGES = [
  { img: 'https://images.unsplash.com/photo-1531123897727-8f11ebb3a745?auto=format&fit=crop&w=400&q=80', n: 'Aminata K.', r: 'Directrice — ONG Hope Life CI', segment: 'ONG', segColor: 'var(--cobalt)', segBg: '#E8EFFC', texte: 'Society nous a permis de professionnaliser notre collecte de fonds. Notre rapport annuel s\'écrit maintenant en 10 minutes. Nos donateurs reçoivent les chiffres en temps réel et on a reçu 3 nouveaux financements grâce à notre page d\'impact.', gain: '+108 % de conversions dons' },
  { img: 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&w=400&q=80', n: 'Awa K.', r: 'Présidente — Mutuelle des Femmes d\'Abobo', segment: 'Mutuelle', segColor: 'var(--hibiscus)', segBg: '#FFFFFF', texte: 'Avant Society, je passais mes week-ends à relancer 200 cotisantes sur WhatsApp. Aujourd\'hui, je suis le suivi en temps réel — et j\'ai du temps pour vraiment animer notre mutuelle et faire grandir notre réseau.', gain: '28 % → 4 % d\'impayés' },
  { img: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=400&q=80', n: 'Kofi A.', r: 'Président — INPHB Alumni Network', segment: 'Alumni', segColor: 'var(--acacia)', segBg: '#DCFCE7', texte: 'Notre réseau alumni de l\'INPHB comptait 12 000 diplômés mais personne ne se connaissait. Avec Society, on a reconstitué le réseau en 3 mois et lancé notre premier programme de mentorat.', gain: 'Gala 4x plus fréquenté' },
  ...
  return (
    <div className="page">
      ...
      <section data-nav-theme="dark" style={{ padding: '120px 64px', minHeight: '70vh', display: 'flex', alignItems: 'center', background: 'var(--encre)', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: -100, left: -100, width: 500, height: 500, borderRadius: '50%', background: 'var(--cobalt)', opacity: 0.08, filter: 'blur(80px)' }} />
        <div style={{ position: 'absolute', top: -60, right: -60, width: 400, height: 400, borderRadius: '50%', background: 'var(--cobalt)', opacity: 0.12, filter: 'blur(80px)' }} />
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '8px 20px', background: 'rgba(212,167,91,0.12)', border: '1px solid rgba(212,167,91,0.3)', borderRadius: 999, marginBottom: 32 }}>
            <div style={{ width: 8, height: 8, borderRadius: '50%', background: 'var(--cobalt-soft)' }} />
            <span style={{ fontSize: 13, fontWeight: 700, color: 'var(--cobalt-soft)', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Bientôt disponible</span>
          </div>
          <h1 style={{ fontSize: 'clamp(48px, 8vw, 80px)', lineHeight: 0.92, color: 'white', maxWidth: 800 }}>
            Témoignages<br />
            <span style={{ color: 'var(--so-blue-soft)' }}>en construction.</span>
          </h1>
      ...
      <section data-nav-theme="dark" style={{ padding: '120px 64px 80px', background: 'var(--encre)', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          <h1 style={{ fontSize: 'clamp(56px, 7vw, 100px)', marginTop: 28, lineHeight: 0.9, maxWidth: 900, color: 'white' }}>
            Ils ont<br />
            <span style={{ color: 'var(--so-blue-soft)' }}>transformé</span><br />
            leur communauté.
          </h1>
